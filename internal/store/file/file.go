...
func New(dir string) (store.State, error) {
	s := Store{
		dir:             dir,
...
func (s *Store) JobRegister() store.JobRegisterState { return &JobRegister{store: s} }
func (s *Store) Region() store.RegionState           { return &Region{store: s} }
